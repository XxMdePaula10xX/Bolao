/**
 * MOTOR DE PONTUAÇÃO — o coração do bolão (PRD seção 6).
 *
 * Regras FIXAS:
 ...
 *  0 = errou tudo
 *  1 = acertou o resultado (vitória/empate) no tempo normal
 *  2 = acertou o empate no tempo normal (1) + quem passa nos pênaltis (+1)
 *  3 = cravou o placar (3)
 *  4 = cravou o placar (3) + quem passa nos pênaltis (+1)
 *
 * Função PURA e sem dependências → é a MESMA usada no app (prévia) e na
 * Cloud Function (fonte da verdade). Nunca duplicar a lógica: importe daqui.
 */
